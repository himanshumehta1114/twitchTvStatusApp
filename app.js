		...
		$.each(usernames,function(i){
			...
			$.getJSON(url, function(data) {
  				$("#tablebody").append("<tr><td><a href='" + data.url +"'><img class='logo' src='" + data.logo + "' alt='channel logo' ></a></td><td><a class='name' href='"+data.url + "'>" +data.display_name+ "</a></td><td><a href='" +data.url+ "'>" + data.status +"</a></td></tr>");
  			console.log(data);});
